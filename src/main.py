...
from visuals.emg_visualizer import EMGVisualizer
...
class MainWindow(QMainWindow):
    ...
    def create_visualization_page(self):
        # 直接实例化我们封装好的类
        self.visualization_page = EMGVisualizer()
        # 注意：由于 EMGVisualizer 本身就是一个 QWidget，
        # 所以它会被直接添加到 self.page_stack 中，无需额外操作。
